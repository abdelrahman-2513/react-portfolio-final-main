...
export const LinkedIn = (props) => {
  return (
    ...
    >
      <path
        fill={props.fill}
        d="M100.28 448H7.4V148.9h92.88zm-46.44-340a53.79 53.79 0 1 1 53.79-53.8 53.79 53.79 0 0 1-53.8 53.8zm394.32 340h-92.68V302.4c0-34.7-12.46-58.4-43.62-58.4-23.77 0-37.9 16-44.18 31.4-2.27 5.5-2.84 13.2-2.84 20.9V448h-92.78s1.23-271.1 0-299.1h92.78v42.4c12.32-19 34.3-46.1 83.48-46.1 60.9 0 106.72 39.7 106.72 125.1z"
      />
    </svg>
  );
};
